  ...
  .config(['$stateProvider', '$urlRouterProvider',
    function ($stateProvider, $urlRouterProvider) {
      ...
      .state('app.create', {
        ...
        .state('app.create.association', {
          url: '/association',
          templateUrl: 'views/create-association.html',
          data: {
        ...
        .state('app.view.association', {
          url: '/association',
          templateUrl: 'views/association-view.html',
          data: {
            title: 'Service Providers',
          }
        })
        ...
        .state('app.forms.validation', {
          url: '/validation',
          templasteUrl: 'views/form-validation.html',
          resolve: {
            deps: ['$ocLazyLoad', function ($ocLazyLoad) {
